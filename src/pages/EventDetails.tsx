            ...
            <div className="bg-white/20 backdrop-blur-xl rounded-3xl overflow-hidden border border-white/30 shadow-2xl hover:shadow-purple-500/20 transition-all duration-500 hover:border-white/40">
              ...
              <div className="p-8">
                ...
                <div className="border-t border-white/20 pt-8 mt-8">
                  <h2 className="text-2xl font-bold text-white mb-6">Stickers & Chances</h2>
                  {rewards.length === 0 ? (
                    <div className="text-center py-8">
                      <Star className="w-12 h-12 text-purple-300 mx-auto mb-4 opacity-50" />
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                      {rewards.map((r, index) => (
                        <div 
                          key={r.rewardId} 
                          className="bg-white/10 rounded-xl p-4 border border-white/20 hover:border-purple-400/50 transition-all duration-300 transform hover:scale-105 hover:bg-white/15 flex items-center space-x-4"
                        ...
                        >
                          ...
                          <div className="flex-1">
                            <div className="text-white font-semibold text-lg">{r.name}</div>
